    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6 bg-white">
            <div class="flex justify-between items-center">
                <h3 class="text-lg font-medium text-gray-900">Enter the details of your expense transaction</h3>
                <div class="flex items-center space-x-3">
                    ...
                    <button type="submit" 
                            form="expenseForm"
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-red-700">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date" 
                           name="date" 
                           id="date" 
                           class="block w-full px-4 py-3 border-gray-300 rounded-md focus:ring-red-500 focus:border-red-500" 
                           required>
                </div>
            </div>
